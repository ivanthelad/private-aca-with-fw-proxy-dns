...
param containerAppName string = 'simple-hello-world-container'
...
@description('keyvaultname to generate certifcate in')
param keyVaultName string = ''
@description('keyvaultname group to generate certifcate in')
...
resource anotherContainerApp 'Microsoft.App/containerapps@2023-04-01-preview' = {
